  ...
  module Token
    ...
    private
      def sso_secret_key
        ...
        begin
          raise "identity_provider_secret_key missing in simple_sso_settings.yml" if Rails.configuration.sso_settings["identity_provider_secret_key"].blank?
        rescue Exception => e
          ErrorPrinter.print_error("Insert key value pair in simple_sso_settings.yml file eg: identity_provider_secret_key: 'my$ecretK3y'")
          raise e
        else
